...
public class NewMessageServiceImpl extends ServiceImpl<NewMessageMapper, NewMessage> implements NewMessageService {
    ...
    @Override
    public Set<Long> existingNewMessageSet(List<Integer> typeList, List<String> medicalTypeList, List<Long> orderIdList, Long userId) {
        LambdaQueryWrapper<NewMessage> queryWrapper = new LambdaQueryWrapper<>();
        ...
        queryWrapper.in(NewMessage::getType, typeList);
    ...
    @Async
    @Override
    public void deleteNewMessage(List<Integer> typeList, String medicalType, Long orderId, Long userId) {
        LambdaQueryWrapper<NewMessage> queryWrapper = new LambdaQueryWrapper<>();
