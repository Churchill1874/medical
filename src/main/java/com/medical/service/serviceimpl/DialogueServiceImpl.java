...
public class DialogueServiceImpl extends ServiceImpl<DialogueMapper, Dialogue> implements DialogueService {
    ...
    @Override
    public void sendDialogue(Dialogue dto,
                             Boolean isAdmin,
                             Long sendId,
                             String sendName,
                             Long receiveId,
        ...
        newMessageService.addNewMessage(type, null, tips, orderId, receiveId, sendName);
    }
    ...
    public void readOnlineConsultationAll(Long id, Long receiveId) {
        ...
        newMessageService.deleteNewMessage(Lists.newArrayList(6),null, id, receiveId);
    }
    ...
    public void readOnlinePrescriptionAll(Long id, Long receiveId) {
        ...
        newMessageService.deleteNewMessage(Lists.newArrayList(1),null, id, receiveId);
    }
