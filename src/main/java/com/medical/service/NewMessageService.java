...
public interface NewMessageService extends IService<NewMessage> {
    ...
    Set<Long> existingNewMessageSet(List<Integer> typeList, List<String> medicalTypeList, List<Long> orderIdList, Long userId);

    void deleteNewMessage(List<Integer> typeList, String medicalType, Long orderId, Long userId);
